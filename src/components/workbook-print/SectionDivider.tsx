...
/**
 * 챕터 구분 본문 — A4 래퍼 없이 내용만 (미리보기/인쇄 공유).
 */
export function SectionDividerContent({ index, title, description, accentColor }: Props) {
  return (
...
/**
 * 챕터 구분 페이지 (인쇄용 wrapper).
 */
export function SectionDivider(props: Props) {
  return (
    <A4PrintPage>
      <SectionDividerContent {...props} />
    </A4PrintPage>
  );
}
