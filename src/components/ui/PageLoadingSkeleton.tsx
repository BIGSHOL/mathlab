...
function FormSkeleton() {
  return (
    <>
      ...
      <div className="bg-white border border-slate-200 rounded-sm p-6 space-y-5 max-w-3xl">
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {Array.from({ length: 6 }, (_, i) => (
          <div key={i} className="bg-white border border-slate-200 rounded-sm p-4 space-y-3">
