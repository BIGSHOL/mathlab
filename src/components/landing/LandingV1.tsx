/**
 * 랜딩 V1 — data/refact2/pages/landing-auth-hifi.html § V1 랜딩 부분
 * 학원장 대상 가치 제안 + 사회적 증거 + 가격 + CTA.
 *
 * 매니페스트 §M3 재사용 — / (v1) 와 /v2/landing 두 곳에서 동일 컴포넌트 사용.
 * href props 로 라우트 분기.
 */
...
const FEATURES = [
  {
    ...
    color: '#1E40AF',
    h: '학교별 기출 자동 분석',
    p: '강남 26개교 5년치 기출을 단원/난이도별로 매트릭스화. 다음 시험 예상 문제를 AI가 자동 출제합니다.',
    tag: '⭐ 학원장 1위 기능',
  },
  {
    ico: '📊',
    ...
    color: '#166534',
    h: '한 화면 학습 분석',
    p: '학생/반/단원별 약점이 히트맵으로. 학부모가 가장 궁금해하는 "우리 애 어디서 막혔어?"에 즉답.',
  },
  {
    ico: '📨',
    bg: '#FEF3C7',
    color: '#B45309',
    h: '학부모 리포트 자동 발송',
    p: '주간/월간 학습 리포트를 PDF로 자동 생성. 카톡으로 일괄 발송. 상담 전화가 80% 줄어듭니다.',
  },
  {
    ico: '📷',
    bg: '#FCE7F3',
    color: '#9F1239',
    h: '사진 채점 + AI 보조',
    p: '학생 풀이 사진 한 장으로 객관식·서술형 채점. 같은 오답은 일괄 표시. 채점 시간 90% 단축.',
  },
  {
    ico: '🎮',
    bg: '#E0E7FF',
    color: '#3730A3',
    h: '학생이 알아서 푸는 게임',
    p: '코인·아바타·리그 시스템. 숙제 안 한다는 부모님 전화가 사라집니다. 평균 풀이 시간 +47%.',
  },
  {
    ico: '🖨️',
    bg: '#FAFAFA',
    color: '#0F172A',
    h: '학습지 + 시험지 자동 제작',
    p: '단원/난이도 선택하면 AI가 즉시 학습지를 출제. PDF 인쇄. QR로 풀이영상도 함께 제공.',
  },
];
...
export type LandingV1Props = {
  /** 로고 클릭 시 이동 (기본 '/' — 자기 자신) */
  homeHref?: string;
  /** 로그인 링크 (기본 '/login') */
  loginHref?: string;
  /** 회원가입/무료체험 링크 (기본 '/login') */
  signupHref?: string;
};
    ...
    <div className="lp-shell">
      ...
      <section className="hero">
        ...
        <div className="hero-grid">
          <div>
            <span className="tg solid" style={{ marginBottom: 14, display: 'inline-block' }}>
              🎉 2025 신학기 학원 247곳 사용 중
            </span>
            <h2>
              학원장님,
              <br />
              <span className="accent">학교 시험 점수</span>로
              <br />
              학부모를 설득하세요
            </h2>
            <p className="sub">
              강남 26개교 5년치 기출 자동 분석.
              <br />
              우리 학원생이 어느 시험 어디서 막혔는지
              <br />
              <b>한 화면으로</b> 확인하고 학부모 리포트를 자동 발송합니다.
            </p>
            <div className="cta-row">
              <Link href={signupHref} className="lp-btn primary">
                무료 체험 30일 →
              </Link>
              <a href="#" className="lp-btn ghost">
                📺 2분 데모 보기
              </a>
            </div>
            <div className="proof">
          ...
          <div className="hero-visual">
            <div className="hero-card hc-1">
              ...
              <svg viewBox="0 0 200 50" style={{ marginTop: 8, width: '100%', height: 40 }}>
                <polyline
                  ...
                  stroke="#3B5BDB"
                  strokeWidth="2.5"
                  points="0,40 30,36 60,32 90,28 120,22 150,18 180,12 200,8"
                />
                <polyline
                  fill="rgba(59,91,219,0.15)"
                  stroke="none"
                  points="0,40 30,36 60,32 90,28 120,22 150,18 180,12 200,8 200,50 0,50"
                />
              </svg>
            </div>
            <div className="hero-card hc-3" style={{ padding: 14 }}>
              ...
              <div className="hc-mini-stat">
                ...
                <div style={{ flex: 1 }}>
                  <div className="lb">예상 등급</div>
                  <div className="v">2등급</div>
                </div>
              </div>
              <div className="hc-mini-stat">
                <div className="ic" style={{ background: '#FEF3C7', color: '#B45309' }}>⚠</div>
                <div style={{ flex: 1 }}>
                  <div className="lb">약점</div>
                  <div className="v" style={{ fontSize: 13 }}>근의공식</div>
                </div>
              </div>
            </div>
            <div className="hero-card hc-2">
              ...
              <div style={{ fontSize: 18, fontWeight: 800, marginTop: 4 }}>
                14
                <small style={{ fontSize: 13, color: 'var(--ink-3)' }}> /14명</small>
              </div>
              <div style={{ fontSize: 11, color: 'var(--success)', fontWeight: 700, marginTop: 2 }}>
                자동 발송 완료 · 5/12
              </div>
      ...
      <section className="stats-row">
        <div className="row" style={{ display: 'flex', justifyContent: 'space-around' }}>
          <div className="stat-block">
            ...
            <div className="lb">사용 학원</div>
          </div>
          <div className="stat-block">
            <div className="v">+8.2점</div>
            <div className="lb">평균 성적 상승</div>
          </div>
          <div className="stat-block">
            <div className="v">
              26<small style={{ fontSize: 18 }}>개교</small>
            </div>
            <div className="lb">강남 학교 DB</div>
          </div>
          <div className="stat-block">
            <div className="v">5년</div>
            <div className="lb">기출 데이터</div>
          </div>
          <div className="stat-block">
            <div className="v">94%</div>
            <div className="lb">학부모 만족도</div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="features">
        ...
        <div className="sub">
          학부모 상담에서 바로 쓸 수 있는 데이터 + 선생님의 반복 작업을 90% 줄입니다.
        </div>
          ...
          <div className="plan-grid">
            {PLANS.map((p, i) => (
              <div key={i} className={`plan-card${p.recommended ? ' recommended' : ''}`}>
                ...
                <Link
                  href={p.cta.variant === 'primary' ? signupHref : loginHref}
                  className={`lp-btn ${p.cta.variant}`}
