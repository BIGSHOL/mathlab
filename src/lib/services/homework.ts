...
// ─── Day Computation (date-engine.ts에서 공통 로직 import) ───
export { computeDayIndex, getDayStatus, getDayDate, toKSTDate } from '@/lib/utils/date-engine';
export type { HomeworkDayStatus } from '@/lib/utils/date-engine';
import { computeDayIndex, getDayDate, getDayStatus, toKSTDate, type HomeworkDayStatus } from '@/lib/utils/date-engine';
