...
export const DEMO_NAVER_BLOCKS: Record<string, DemoNaverBlock[]> = {
  "고1": [
    ...
    },
    {
      ...
      "summary": "질문 1 · 학부모 인터뷰 — 총 20문항 100점으로, 선택형 13문항(50점)과 서술형 7문항(50점)이 정확히 반반입니다."
    },
    {
      "path": "/demo-naver/g1/s6.jpg",
      "summary": "질문 2 · 학부모 인터뷰 — 배점 기준으로 가장 비중이 큰 단원은 나머지정리(16점)와 복소수의 연산(16점)으로 각각 전체의 16%를 차지합니다."
    },
    {
      "path": "/demo-naver/g1/s7.jpg",
      "summary": "질문 3 · 학부모 인터뷰 — 서술형 7문항(50점)의 출제 단원은 다항식의 곱셈과 나눗셈·항등식·고차식 인수분해·나머지정리(다항식 영역)와 복소수의 연산·이차방정식의 근과 계수의 관계·이차함수의 최대·최소(방정식과 부등식 영역)로 양 영역에 고르게 "
    },
    {
      "path": "/demo-naver/g1/s8.jpg",
      "summary": "질문 4 · 학부모 인터뷰 — 첫째, 복소수의 연산과 이차함수의 최대·최소를 4단계 수준까지 완성하세요."
    },
    {
  ...
  "중2": [
    ...
    },
    {
      ...
      "summary": "질문 1 · 학부모 인터뷰 — 총 22문항 100점으로, 난이도는 기본(1단계) 2문항·표준(2단계) 7문항·응용(3단계) 9문항·심화(4단계) 4문항으로 구성됐습니다."
    },
    {
      "path": "/demo-naver/m2/s6.jpg",
      "summary": "질문 2 · 학부모 인터뷰 — 배점 기준으로 가장 비중이 큰 단원은 일차부등식(7문항 33점)과 유리수와 순환소수(7문항 31점)입니다."
    },
    {
      "path": "/demo-naver/m2/s7.jpg",
      "summary": "질문 3 · 학부모 인터뷰 — 서술형 6문항(40점)은 유리수(서답형1·5, 13점), 다항식의 계산(서답형2, 6점), 단항식의 계산(서답형3, 7점), 일차부등식(서답형4·6, 14점)에서 고르게 출제됐습니다."
    },
    {
      "path": "/demo-naver/m2/s8.jpg",
      "summary": "질문 4 · 학부모 인터뷰 — 첫째, 일차부등식 서술형 풀이 형식을 반드시 훈련하세요."
    },
    {
  ...
  "중3": [
    ...
    },
    {
      ...
      "summary": "질문 1 · 학부모 인터뷰 — 총 21문항 100점 만점으로, 실수와 그 연산 영역과 다항식의 곱셈·인수분해 영역이 균형 있게 출제됐습니다."
    },
    {
      "path": "/demo-naver/m3/s6.jpg",
      "summary": "질문 2 · 학부모 인터뷰 — 제곱근의 계산이 6문항 29점으로 가장 큰 비중을 차지합니다."
    },
    {
      "path": "/demo-naver/m3/s7.jpg",
      "summary": "질문 3 · 학부모 인터뷰 — 서술형 5문항은 모두 8점씩 배점되며, 절댓값 조건 판별(서답형1·4단계), 무리수의 정수·소수 부분 구하기(서답형2·3단계), 혼합 계산(서답형3·3단계), 잘못 본 식 유추(서답형4·4단계), 도형 활용 인수분해(서답"
    },
    {
      "path": "/demo-naver/m3/s8.jpg",
      "summary": "질문 4 · 학부모 인터뷰 — 첫째, 제곱근의 계산 반복 훈련이 최우선입니다."
    },
    {
