...
- **정보 중복 금지**: 같은 수치를 본문 서술과 리스트에서 이중으로 나열하지 말 것. 본문에서 요약 → 리스트에서 상세, 또는 둘 중 하나만 선택
- **문장 종결어 변화**: "~입니다/~됩니다"만 반복하지 말 것. "~해야 합니다", "~어렵습니다", "~보입니다", "~필요합니다", "~드러납니다" 등 다양한 종결어 사용

### 학원 홍보 (자연스럽게, 본문과 톤 일치)
- 글 마지막 1~2문장으로 자연스럽게 마무리. 별도 단락으로 분리하지 말 것
- ✓ "이러한 출제 경향을 반영한 단원별 맞춤 전략이 궁금하시면 언제든 문의 주시기 바랍니다." (분석 흐름의 연장선)
- ✗ "저희 학원에서는 ~수업을 진행하고 있습니다. ~방문 또는 문의 주시기 바랍니다." (갑작스러운 광고 전환)
