...
export const COMMON_MISTAKES: UnitMistakes[] = [
  ...
  {
    unit: '함수',
    grade: '고등',  // 정의역·치역·공역 기본 개념 (공통수학2)
    mistakes: [
      {
        keywords: ['함수', '함수의 뜻'],
        mistakes: [
...
export const KILLER_QUESTION_TYPES: KillerQuestionType[] = [
  ...
  {
    unit: '연립방정식의 풀이',
    keywords: ['연립방정식의 풀이', '가감법', '대입법'],
    killerPatterns: [
      {
        pattern: '계수 맞추기 실수',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '가감법에서 한 식에만 상수를 곱하면서 부호를 바꾸지 않거나, 대입법에서 치환 후 원래 변수로 복원하지 않음',
        solutionKey: [
          '가감법: 제거할 문자의 계수의 절댓값을 같게 만들기',
          '대입법: 한 문자를 다른 문자로 표현 → 나머지 식에 대입',
          '구한 값을 원래 두 식 모두에 대입하여 검증',
        ],
        exampleSetup: '2x + 3y = 7, 3x - 2y = 4를 가감법으로 풀어라.',
      },
    ],
  },
  {
    ...
    killerPatterns: [
      {
        ...
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '이등변삼각형의 밑각이 같다는 성질을 이용하지 않거나, 꼭지각의 이등분선이 밑변을 수직이등분하는 성질을 빠뜨림',
        solutionKey: [
          '밑각의 크기가 같음',
          '꼭지각의 이등분선 = 밑변의 수직이등분선 = 중선',
          '역: 두 각이 같으면 이등변삼각형',
        ],
        exampleSetup: '이등변삼각형의 꼭지각이 40°일 때, 밑각의 크기는?',
      },
    ],
  },
  {
    unit: '외심',
    keywords: ['외심', '외접원', '삼각형의 외심'],
    killerPatterns: [
      {
        pattern: '외심의 위치와 거리',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '외심에서 세 꼭짓점까지의 거리가 같다는 성질(외접원 반지름)을 이용하지 않거나, 외심이 삼각형 외부에 있을 수 있음을 모름',
        solutionKey: [
          '외심 = 세 변의 수직이등분선의 교점',
          '외심에서 세 꼭짓점까지 거리 동일 (= 외접원 반지름)',
          '둔각삼각형: 외심이 삼각형 외부, 직각삼각형: 빗변의 중점',
        ],
        exampleSetup: '세 변의 길이가 3, 4, 5인 직각삼각형의 외접원의 반지름은?',
      },
    ],
  },
  {
    ...
    killerPatterns: [
      {
        ...
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '평행사변형이 되기 위한 5가지 조건 중 일부만 기억하여 판별 문제에서 틀림',
        solutionKey: [
          '① 두 쌍의 대변이 평행 ② 두 쌍의 대변의 길이가 같음',
          '③ 두 쌍의 대각의 크기가 같음 ④ 대각선이 서로 다른 것을 이등분',
          '⑤ 한 쌍의 대변이 평행하고 길이가 같음',
        ],
        exampleSetup: '□ABCD에서 AB//DC, AB = DC일 때, □ABCD가 평행사변형인 이유를 설명하시오.',
      },
    ],
  },
  {
    unit: '여러 가지 사각형',
    keywords: ['여러 가지 사각형', '직사각형', '마름모', '정사각형'],
    killerPatterns: [
      {
        pattern: '사각형의 포함 관계',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '정사각형 ⊂ 직사각형, 정사각형 ⊂ 마름모 관계를 모르거나, 대각선 성질로 사각형 종류를 판별하지 못함',
        solutionKey: [
          '평행사변형 + 한 각 90° → 직사각형',
          '평행사변형 + 이웃하는 두 변 같음 → 마름모',
          '직사각형 + 마름모 → 정사각형',
        ],
        exampleSetup: '대각선이 서로를 수직이등분하는 사각형은 어떤 사각형인가?',
      },
    ],
  },
  {
    unit: '닮음의 뜻',
    keywords: ['닮음의 뜻', '닮음', '닮음비'],
    killerPatterns: [
      {
        pattern: '닮음비와 넓이비·부피비',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '닮음비 m:n일 때 넓이비를 m:n으로 계산하거나, 부피비를 m²:n²으로 계산하는 실수',
        solutionKey: [
          '닮음비 m:n → 넓이비 m²:n²',
          '닮음비 m:n → 부피비 m³:n³',
          '둘레의 비 = 닮음비 m:n',
    ...
    killerPatterns: [
      {
        ...
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '합동 조건(SSS, SAS, ASA)과 닮음 조건(AA, SAS, SSS)을 혼동하거나, SAS 닮음에서 끼인각이 아닌 각을 사용',
        solutionKey: [
          'AA 닮음: 두 쌍의 대응각이 같으면 닮음 (가장 많이 사용)',
          'SAS 닮음: 두 쌍의 대응변의 비가 같고 끼인각이 같음',
          'SSS 닮음: 세 쌍의 대응변의 비가 모두 같음',
        ],
        exampleSetup: '△ABC에서 ∠A = ∠D이고 AB:DE = AC:DF일 때 닮음인 이유는?',
      },
    ],
  },
  {
  ...
  {
    unit: '제곱근의 뜻',
    keywords: ['제곱근의 뜻', '제곱근', '근호'],
    killerPatterns: [
      {
        pattern: '제곱근과 √ 기호의 구분',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '4의 제곱근은 ±2인데 √4 = ±2로 잘못 쓰거나, √4 = 2(양수만)임을 모름',
        solutionKey: [
          'a의 제곱근: ±√a (양수, 음수 둘 다)',
          '√a: a의 양의 제곱근 (항상 양수)',
          '√a² = |a| (절댓값)',
        ],
        exampleSetup: '(-3)²의 양의 제곱근은?',
      },
    ],
  },
  {
  ...
  {
    unit: '근호를 포함한 식의 곱셈과 나눗셈',
    keywords: ['근호를 포함한 식의 곱셈', '근호를 포함한 식의 나눗셈'],
    killerPatterns: [
      {
        pattern: '분모의 유리화',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '1/√3을 유리화할 때 분자에도 √3을 곱하는 것을 빠뜨리거나, √a × √b = √(ab)에서 음수 처리 오류',
        solutionKey: [
          '√a × √b = √(ab) (a ≥ 0, b ≥ 0)',
          '√a ÷ √b = √(a/b)',
          '분모 유리화: 분모·분자에 같은 √ 값을 곱함',
        ],
        exampleSetup: '6/√3을 분모를 유리화하여 나타내시오.',
      },
    ],
  },
  {
    unit: '근호를 포함한 식의 덧셈과 뺄셈',
    keywords: ['근호를 포함한 식의 덧셈', '근호를 포함한 식의 뺄셈'],
    killerPatterns: [
      {
        pattern: '√ 안의 수가 다른 항의 계산',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '√2 + √3 = √5로 계산하거나, √12를 2√3으로 변환하지 않고 계산',
        solutionKey: [
          '√ 안의 수가 같은 것끼리만 더하고 뺄 수 있음',
          '√12 = 2√3, √18 = 3√2 등 먼저 간단히 변환',
          '√a + √b ≠ √(a+b) (절대 성립하지 않음)',
        ],
        exampleSetup: '√12 + √27 - √3을 계산하시오.',
      },
    ],
  },
  {
  ...
  {
    unit: '원과 현',
    keywords: ['원과 현', '현', '현의 수직이등분', '원의 중심과 현'],
    killerPatterns: [
      {
        pattern: '원의 중심에서 현까지의 거리',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '원의 중심에서 현에 수선을 내리면 현을 이등분한다는 성질을 적용하지 않아 직각삼각형을 만들지 못함',
        solutionKey: [
          '원의 중심에서 현에 내린 수선은 현을 이등분',
          '반지름, 수선의 길이, 현의 절반으로 직각삼각형 형성',
          '피타고라스 정리로 길이 계산',
        ],
        exampleSetup: '반지름 10인 원에서 중심까지 거리가 6인 현의 길이는?',
      },
    ],
  },
  {
    unit: '원주각',
    keywords: ['원주각', '중심각', '원주각의 성질'],
    killerPatterns: [
      {
        pattern: '원주각과 중심각의 관계 복합',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: '같은 호에 대한 원주각이 같다는 성질과 반원에 대한 원주각=90° 조건이 동시에 적용되는 복합 문제',
        solutionKey: [
          '같은 호에 대한 원주각 = 중심각의 1/2',
          '같은 호에 대한 원주각은 모두 같음',
          '반원(지름)에 대한 원주각 = 90°',
        ],
        exampleSetup: 'AB가 원 O의 지름이고 호 BC에 대한 원주각이 35°일 때, ∠BAC는?',
      },
      {
        pattern: '원에 내접하는 사각형',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: '원에 내접하는 사각형의 대각의 합이 180°임을 이용하지 않거나, 한 꼭짓점의 외각이 맞은편 내각과 같음을 모름',
        solutionKey: [
          '대각의 합 = 180°',
          '한 외각 = 맞은편 내각',
          '원주각의 성질과 조합하여 각도 계산',
        ],
        exampleSetup: '원에 내접하는 사각형 ABCD에서 ∠A = 110°일 때, ∠C는?',
      },
    ],
  },
  {
  ...
  {
    unit: '행렬의 연산',
    keywords: ['행렬의 연산', '행렬의 덧셈', '행렬의 곱셈', '행렬의 실수배'],
    killerPatterns: [
      {
        pattern: '행렬의 곱셈 비교환성',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: 'AB = BA라고 가정하고 계산하거나, 행렬 곱에서 행×열 계산을 잘못 대응',
        solutionKey: [
          'AB ≠ BA (일반적으로 교환법칙 불성립)',
          '(m×n) × (n×p) = (m×p) — 앞 행렬의 열 수 = 뒤 행렬의 행 수',
          '행의 각 원소 × 열의 대응 원소의 합',
        ],
        exampleSetup: 'A = ((1, 2), (3, 4)), B = ((5, 6), (7, 8))일 때, AB와 BA를 각각 구하시오.',
      },
    ],
  },
  {
  ...
  {
    unit: '집합의 연산',
    keywords: ['집합의 연산', '합집합', '교집합', '여집합', '차집합'],
    killerPatterns: [
      {
        pattern: '드모르간의 법칙',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '(A∪B)ᶜ = Aᶜ∩Bᶜ에서 ∪와 ∩이 바뀌는 것을 혼동하거나 벤다이어그램 없이 계산',
        solutionKey: [
          '(A∪B)ᶜ = Aᶜ∩Bᶜ, (A∩B)ᶜ = Aᶜ∪Bᶜ',
          'n(A∪B) = n(A) + n(B) - n(A∩B)',
          '벤다이어그램을 그려 확인',
        ],
        exampleSetup: 'U = {1,2,...,10}, A = {1,3,5,7}, B = {2,3,5,8}일 때 (A∩B)ᶜ는?',
      },
    ],
  },
  {
    ...
    killerPatterns: [
      {
        pattern: '사인법칙과 외접원 반지름',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: 'a/sinA = 2R에서 R을 구한 뒤, 둔각인 경우 사인값의 부호를 잘못 처리하거나 코사인법칙과 혼용 시 적용 조건을 혼동',
        solutionKey: [
          'a/sinA = b/sinB = c/sinC = 2R (R: 외접원 반지름)',
          '각이 주어지면 사인법칙, 세 변이 주어지면 코사인법칙',
          '둔각삼각형에서 sin(180°-θ) = sinθ 활용',
        ],
        exampleSetup: '△ABC에서 a = 4, ∠A = 30°일 때, 외접원 반지름 R은?',
      },
    ],
  },
  {
    unit: '시그마',
    keywords: ['시그마', 'Σ', '시그마의 성질', '합의 기호'],
    killerPatterns: [
      {
        pattern: '시그마 공식 혼합 적용',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: 'Σk² 공식에서 분모 6을 빠뜨리거나, Σ(ak+b)를 aΣk + nb로 분리할 때 항의 수를 잘못 계산',
        solutionKey: [
          'Σk = n(n+1)/2, Σk² = n(n+1)(2n+1)/6, Σk³ = {n(n+1)/2}²',
          'Σ(ak+b) = aΣk + nb (상수 분리)',
          '시작값이 1이 아닐 때: Σ(k=m~n) = Σ(k=1~n) - Σ(k=1~m-1)',
        ],
        exampleSetup: 'Σ(k=1~20)(3k² - 2k + 1)의 값은?',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    killerPatterns: [
      {
        pattern: '중복순열과 중복조합의 구분',
        difficulty: '상',
        frequency: '자주출제',
        trapDescription: '순서가 의미 있는 경우(중복순열)와 순서 없이 선택하는 경우(중복조합)를 구분하지 못함',
        solutionKey: [
          '중복순열 nΠr = nʳ (n개에서 r개를 중복 허용하여 순서대로)',
          '중복조합 nHr = ₙ₊ᵣ₋₁Cᵣ (n개에서 r개를 중복 허용하여 순서 없이)',
          '문제에서 "순서" 키워드 확인',
        ],
        exampleSetup: '1, 2, 3, 4에서 중복을 허락하여 3자리 자연수를 만드는 경우의 수는?',
      },
    ],
  },
  {
    unit: '표본평균',
    keywords: ['표본평균', '표본평균의 분포', '모평균의 추정'],
    killerPatterns: [
      {
        pattern: '표본평균의 평균과 분산',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: 'V(X̄) = σ²/n에서 n을 빠뜨리거나, 표본의 크기가 충분히 클 때 정규분포 근사를 적용하지 않음',
        solutionKey: [
          'E(X̄) = μ (모평균)',
          'V(X̄) = σ²/n → σ(X̄) = σ/√n',
          'n이 충분히 크면 X̄ ~ N(μ, σ²/n) (중심극한정리)',
        ],
        exampleSetup: '모평균 50, 모표준편차 10인 모집단에서 크기 25인 표본의 X̄의 분포는?',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    killerPatterns: [
      {
        pattern: '치환 후 적분 범위 변환',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: '정적분에서 t = g(x)로 치환한 후 적분 범위를 x에서 t로 바꾸지 않고 원래 범위로 계산',
        solutionKey: [
          't = g(x)로 치환하면 dt = g\'(x)dx',
          '정적분: x의 범위를 t의 범위로 반드시 변환',
          '부정적분: 적분 후 t를 x로 다시 역치환',
        ],
        exampleSetup: '∫₀² x√(x²+1) dx를 t = x²+1로 치환하여 계산하시오.',
      },
    ],
  },
  {
  ...
  {
    unit: '삼수선 정리',
    keywords: ['삼수선 정리', '삼수선', '이면각'],
    killerPatterns: [
      {
        pattern: '삼수선 정리 적용',
        difficulty: '최상',
        frequency: '자주출제',
        trapDescription: '평면 α에 수선 PA를 내리고, α 위의 직선 l에 A에서 수선 AH를 내렸을 때, PH⊥l인 것을 모르거나 역의 적용을 잊음',
        solutionKey: [
          'PA⊥α, AH⊥l (l⊂α) ⟹ PH⊥l',
          '역: PA⊥α, PH⊥l (l⊂α) ⟹ AH⊥l',
          '이면각 계산: 삼수선 정리로 수선의 발을 잡고 직각삼각형 형성',
        ],
        exampleSetup: '정사면체 ABCD에서 꼭짓점 A에서 면 BCD에 내린 수선의 발 H를 이용하여 이면각을 구하시오.',
      },
    ],
  },
];
