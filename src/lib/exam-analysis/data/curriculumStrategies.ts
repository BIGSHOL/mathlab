 ...
 *
 * 2026-04-29 분리 완료: GRADE_CONNECTIONS, KILLER_QUESTION_TYPES (총 6,000줄+) → ./curriculum/{gradeConnections,killerPatterns}.ts
 */

import { isTopicMatch } from './curriculum/utils';
...
// 학년별 연계 경고는 ./curriculum/gradeConnections.ts로 이동 (2026-04-29)
...
// 단원별 킬러 문항 유형은 ./curriculum/killerPatterns.ts로 이동 (2026-04-29)
