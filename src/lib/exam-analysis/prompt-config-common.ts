/**
 * 프롬프트 공통 설정
 * Python prompt_config_common.py에서 1:1 이식
 * 과목 공통으로 사용되는 규칙과 설정
 */

// ── 배점 검증 규칙 ──
export const POINTS_VALIDATION_RULES = `📊 **[필수] 배점 검증 원칙**
...
// ── 내신 과목 분류 원칙 ──
export const EXAM_SUBJECT_CLASSIFICATION = `🎯 **내신 시험지 과목 분류 원칙**
...
// ── 학교급 분리 규칙 ──
export const SCHOOL_LEVEL_RULES = `⚠️ **[필수] 학년 정보 우선 원칙**
...
// ── 5단계 난이도 시스템 ──
export const DIFFICULTY_SYSTEM_FRAMEWORK = `🚨 **5단계 난이도 시스템 (공통 원칙)**
