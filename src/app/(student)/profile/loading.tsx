          ...
          <div className="bg-white border border-slate-200 rounded-sm p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {Array.from({ length: 4 }, (_, i) => (
                <div key={i} className="flex items-center gap-1.5 px-2.5 py-2 rounded-sm bg-slate-50">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-5">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
            {Array.from({ length: 6 }, (_, i) => (
              <div key={i} className="flex flex-col items-center gap-2 p-3 rounded-sm bg-slate-50">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-5">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-3">
            {Array.from({ length: 16 }, (_, i) => (
              <div key={i} className="flex flex-col items-center p-2 rounded-sm border border-slate-100 h-[114px] justify-center">
