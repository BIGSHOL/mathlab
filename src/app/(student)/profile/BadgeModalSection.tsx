            ...
            {items.map(({ badge, group, isEarned, earnedDate }) => {
                ...
                return (
                    ...
                    >
                        ...
                        {/* 배지 아이콘 */}
                        <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center text-2xl shrink-0 mb-1.5 shadow-inner overflow-hidden ${isEarned ? '' : 'opacity-40'} ${(!isEarned && isHidden) ? '' : badge.icon.startsWith('/') ? 'ring-1 ring-black/5' : ''}`}
